...
def volatility(returns, periods=8760, annualize=True):
...
def implied_volatility(returns, periods=8760, annualize=True):
...
def sharpe(returns, rf=0., periods=8760, annualize=True):
    """
...
def sortino(returns, rf=0, periods=8760, annualize=True):
    """
...
def greeks(returns, benchmark, periods=8760.):
...
def rolling_greeks(returns, benchmark, periods=8760):
